...
\usepackage[urlcolor=teal,colorlinks=true]{hyperref} %for \url
\usepackage{xstring} %pull out substrings in newcommands
\usepackage{pifont} %dings
\usepackage[outline]{contour} %bolder bold
...
\newcommand{\sectionheader}[1]{
    ...
    \textbf{\LARGE
        ...
        \contourlength{.1pt}
        \hspace{-20pt}
        \contour{lightgreen}{\textcolor{lightgreen}{\firstpart}}
        \hspace{-13pt} %remove extra space added by super bold
        \lastpart
    }\\[5pt]
}

\newcommand{\dates}[2]{
    \textbf{#1-\textcolor{lightgreen}{#2}}
...
\begin{document}
    ...
    \textbf{\large Thales USA} \hfill \dates{July 2017}{Current}\\
    \textit{Software Engineer}
    \begin{things}
        \thing Troubleshoot and identify systems issues in 
                    the lab prior to them being fielded
        \thing Coordinate with Generic IVV and System Software Integrators
                    to anticipate issues on customer labs
    ...
    \textit{Software Design and Programming Intern}
    \begin{things}
    ...
    \textit{Software Design and Programmer}
    \begin{things}
