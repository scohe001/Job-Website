...
\begin{document}
    ...
    \begin{things}
        \thing Lead several recurring team meetings including scrum and retro.
                    I take pride in my ability to bring our team together
        \thing Taken the lead on several large scale projects
        \thing Work closely with clients, our product managers, and other product 
                    teams (in the case of integrations) to deliver features to
                    client expectations in a timely manner
        \thing Taught support reps SQL and enabled them to complete basic common data fixes,
                    saving ~100 dev days of work a year
